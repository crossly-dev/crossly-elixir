...
defmodule CrosslyBuyerAPI.Model.GetPlatformLimitResponseEbaySellingCap do
  @moduledoc """
...
defimpl Poison.Decoder, for: CrosslyBuyerAPI.Model.GetPlatformLimitResponseEbaySellingCap do
