...
defmodule CrosslySellerAPI.Model.CreateMagicScanSynthesizeResponsePayloadSectionApplicability do
  @moduledoc """
...
defimpl Poison.Decoder, for: CrosslySellerAPI.Model.CreateMagicScanSynthesizeResponsePayloadSectionApplicability do
